...
def all_tools() -> list[Tool]:
    ...
    return [
        ...
        Tool(
            key="research-request-diagnostic-console",
            title="Research Request Diagnostic Console",
            icon="\U0001F50E",
            tagline=(
                "Client request reframer, methodology evaluator, and US "
                "market context layer."
            ),
            audience="Market research and insight",
            render=research_request_diagnostic_console,
        ),
        Tool(
            key="school-bus-routing-console",
            title="School Bus Routing & Network Analyst Console",
            icon="\U0001F68C",
            tagline=(
                "Street network distance evaluator, VRP stop consolidation "
                "engine, and cost impact matrix."
            ),
        ...
        Tool(
            key="holiday-lighting-cv-console",
            title="Holiday Lighting CV Geometry Console",
            icon="\U0001F4A1",
            tagline=(
                "SAM3 polygon eave extractor, RANSAC roofline fitter, and "
                "occlusion gap bridging simulator."
            ),
        ...
        Tool(
            key="joor-apparel-sync-console",
            title="JOOR ApparelMagic & Extensiv Sync Console",
            icon="\U0001F457",
            tagline=(
                "B2B wholesale order ingestion, style size matrix mapping, "
                "and Extensiv 3PL inventory reconciler."
            ),
